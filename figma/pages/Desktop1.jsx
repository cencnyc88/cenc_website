    ...
    <div className="desktop-1">
      <div className="container-4">
        ...
        <div className="body">
          ...
          <div className="goal-1-container">
            ...
            <div className="longevity-symbol">
            </div>
          </div>
          <div className="goal-2-container">
            <div className="container-1">
              <div className="pheonix-symbol">
              </div>
              <div className="container-6">
                <span className="goal-2-quote">
                千軍易得，一將難求
                </span>
              </div>
            </div>
          ...
          <div className="goal-4-container">
            <div className="yin-yang-symbol">
            </div>
            <div className="container-11">
              <span className="goal-4-script">
      ...
      <div className="footer">
        <div className="founder-container">
          ...
          Founded by the Democratic District Leader of 65AD
          </span>
        </div>
        <div className="contact-container">
          <div className="container-12">
            ...
            Feel free to visit us @ 88 East Broadway New York, NY 10004 Unit #153 <br />
            
            </span>
            <div className="email">
            Feel free to email us @ cencnyc@gmail.com 
            </div>
            <div className="container-8">
              <span className="copyright-label">
              Copyright © 2024 Chinatown East Neighboard Council. All Rights Reserved.
              </span>
            </div>
          </div>
        </div>
